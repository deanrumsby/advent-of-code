...
# order for more. They have a list of the dimensions
# (length l, width w, and height h) of each present, and only want to order
...
# only have to worry about the length they need to order, which they would
